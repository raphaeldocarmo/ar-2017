...
/* @overview/index.twig */
class __TwigTemplate_67e6206474b74aaa6403e8369aebce31b047c061d78cd02e414ed2d9a68e8d71 extends Twig_Template
{
...
$context["form"]->gettext("name", $this->getAttribute((isset($context["contactForm"]) ? $context["contactForm"] : null), "name", array()), array("required" => "")));
        echo "

                    ";
        // line 118
        echo $context["form"]->getrow((call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Email")) . " *"),         // line 119
$context["form"]->gettext("email", $this->getAttribute((isset($context["contactForm"]) ? $context["contactForm"] : null), "email", array()), array("required" => "")));
        echo "

                    ";
        // line 121
        echo $context["form"]->getrow((call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Website")) . " *"),         // line 122
$context["form"]->gettext("website", $this->getAttribute((isset($context["contactForm"]) ? $context["contactForm"] : null), "website", array()), array("required" => "")));
        echo "
...
";
    ...
    {
        return new Twig_Source("", "@overview/index.twig", "/home/ubuntu/workspace/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Overview/views/index.twig");
    }
}
