(function ($, undefined) {
    ...
    Gallery.prototype.initPopup = (function() {
        ...
        if(popupType == 'pretty-photo') {
            ...
            if(!this.$prettyPhoto) {
				...
				// simple selector
				var prettyPhotoItemSelector = '.grid-gallery-photos > a[data-rel^="prettyPhoto"],'
					// mosaic selector
    ...
    Gallery.prototype.correctMargin = (function () {
        if(!this.isFluidHeight() && !this.$container.data('horizontal-scroll') && this.$container.data('gridType') != 4) {
