...
class Easy_Timetable_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name. " tooltipster3", plugin_dir_url( __FILE__ ) . 'tooltipster/css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-light.min.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script('jQuery-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js', "", "", false);
		...
		wp_enqueue_script( $this->plugin_name. " print", plugin_dir_url( __FILE__ ) . 'js/dist/html2canvas.min.js', array( 'jquery' ), $this->version, false );
		wp_enqueue_script( $this->plugin_name. " printsvg", plugin_dir_url( __FILE__ ) . 'js/dist/html2canvas.svg.min.js', array( 'jquery' ), $this->version, false );		
	}
}
